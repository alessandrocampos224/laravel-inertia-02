...
<head>
    ...
    <!-- END: Vendor CSS-->
     ...
     <!-- BEGIN: Page CSS-->
     <link rel="stylesheet" type="text/css" href="_dist/admin/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="_dist/admin/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="_dist/admin/css/pages/dashboard-analytics.css">
    <link rel="stylesheet" type="text/css" href="_dist/admin/css/pages/card-analytics.css">
    <link rel="stylesheet" type="text/css" href="_dist/admin/css/plugins/tour/tour.css">
    <!-- END: Page CSS-->
     <!-- BEGIN: Custom CSS-->
     <link rel="stylesheet" type="text/css" href="_dist/admin/css/style.css">
    <!-- END: Custom CSS-->
    {{-- Theme Styles --}}
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="_dist/admin/vendors/js/vendors.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="_dist/admin/vendors/js/charts/apexcharts.min.js"></script>
    <script src="_dist/admin/vendors/js/extensions/tether.min.js"></script>
    <script src="_dist/admin/vendors/js/extensions/shepherd.min.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="_dist/admin/js/core/app-menu.js"></script>
    <script src="_dist/admin/js/core/app.js"></script>
    <script src="_dist/admin/js/scripts/components.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="_dist/admin/js/scripts/pages/dashboard-analytics.js"></script>
    <!-- END: Page JS-->
</body>
