      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex">
            <div class="mr-50">
              <img
                src="/_dist/admin/images/icons/xls.png"
                alt="png"
                height="32"
              />
            </div>
      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex">
            <div class="mr-50">
              <img
                src="/_dist/admin/images/icons/jpg.png"
                alt="png"
                height="32"
              />
            </div>
      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex">
            <div class="mr-50">
              <img
                src="/_dist/admin/images/icons/pdf.png"
                alt="png"
                height="32"
              />
            </div>
      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex">
            <div class="mr-50">
              <img
                src="/_dist/admin/images/icons/doc.png"
                alt="png"
                height="32"
              />
            </div>
        ...
        >
          <div class="d-flex align-items-center">
            <div class="avatar mr-50">
              <img
                src="/_dist/admin/images/portrait/small/avatar-s-8.jpg"
                alt="png"
                height="32"
              />
            </div>
      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex align-items-center">
            <div class="avatar mr-50">
              <img
                src="/_dist/admin/images/portrait/small/avatar-s-1.jpg"
                alt="png"
                height="32"
              />
            </div>
      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex align-items-center">
            <div class="avatar mr-50">
              <img
                src="/_dist/admin/images/portrait/small/avatar-s-14.jpg"
                alt="png"
                height="32"
              />
            </div>
      ...
      <li class="auto-suggestion d-flex align-items-center cursor-pointer">
        ...
        >
          <div class="d-flex align-items-center">
            <div class="avatar mr-50">
              <img
                src="/_dist/admin/images/portrait/small/avatar-s-6.jpg"
                alt="png"
                height="32"
              />
            </div>
        ...
        >
          ...
          <li class="nav-item">
            <a href="#"
              ...
              ><span class="menu-title" data-i18n="Data List">Data List</span
              ><span
            ...
            <ul class="menu-content">
              <li>
                <a href="data-list-view.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="List View"
                    >List View</span
                  ></a
                >
              </li>
              <li>
                <a href="data-thumb-view.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Thumb View"
                    >Thumb View</span
                  ></a
                >
              </li>
            ...
            <ul class="menu-content">
              <li>
                <a href="icons-feather.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Feather">Feather</span></a
                >
              </li>
              <li>
                <a href="icons-font-awesome.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Font Awesome"
                    >Font Awesome</span
                  ></a
                >
              </li>
            ...
            <ul class="menu-content">
              ...
              <li>
                <a href="card-advance.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Advance">Advance</span></a
                >
              </li>
              <li>
                <a href="card-statistics.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Statistics"
                    >Statistics</span
                  ></a
                >
              </li>
            ...
            <ul class="menu-content">
              ...
              <li>
                <a href="component-navs-component.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Navs Component"
                    >Navs Component</span
                  ></a
                >
              </li>
          ...
          <li class="nav-item">
            <a href="table-ag-grid.html"
              ><i class="feather icon-grid"></i
              ><span class="menu-title" data-i18n="ag-grid">agGrid Table</span
              ><span
                class="badge badge badge-primary badge-pill float-right mr-2"
                >New</span
              ></a
          ...
          <li class="nav-item">
            <a href="page-user-profile.html"
              ><i class="feather icon-user"></i
              ><span class="menu-title" data-i18n="Profile">Profile</span></a
            >
          </li>
          <li class="nav-item">
            ...
            <ul class="menu-content">
              ...
              <li>
                <a
                  ...
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Floating navbar"
            ...
            <ul class="menu-content">
              ...
              <li>
                <a href="chart-echarts.html"
                  ><i class="feather icon-circle"></i
                  ><span class="menu-item" data-i18n="Echarts">Echarts</span></a
                >
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <a href="ext-component-quill-editor.html"
              ...
              ><span class="menu-title" data-i18n="Quill Editor"
                >Quill Editor</span
              ></a
            >
          </li>
          ...
          <li class="nav-item">
            <a href=" ext-component-plyr.html"
              ...
              ><span class="menu-title" data-i18n="Media player"
                >Media player</span
              ></a
            >
          </li>
          <li class="nav-item">
            <a href="ext-component-context-menu.html"
              ...
              ><span class="menu-title" data-i18n="Context Menu"
                >Context Menu</span
              ></a
            >
          </li>
          <li class="nav-item">
            <a href="ext-component-swiper.html"
              ...
              ><span class="menu-title" data-i18n="swiper">swiper</span></a
            >
          </li>
          <li class="nav-item">
            <a href="ext-component-i18n.html"
              ><i class="feather icon-globe"></i
              ><span class="menu-title" data-i18n="l18n">l18n</span></a
            >
          </li>
